...
export default function DashboardPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080810', color: '#e8e8f0', padding: '32px' }}>
      ...
      {upgraded && (
        <div style={{
          background: 'rgba(63,207,142,0.1)', border: '1px solid rgba(63,207,142,0.3)',
          borderRadius: 12, padding: '16px 20px', color: '#3fcf8e', marginBottom: 32,
      ...
      {/* Welcome */}
      <h1 style={{ fontFamily: 'serif', fontSize: 36, fontWeight: 900, marginBottom: 8, letterSpacing: '-0.02em' }}>
      ...
      {loading ? (
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 16 }}>
            <div>
              ...
              <div style={{ fontSize: 14, color: '#7c6dfa', fontFamily: 'monospace' }}>
                portfolioai.vercel.app/{portfolio.slug}
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <Link href="/" style={{
                padding: '10px 20px', background: '#7c6dfa',
        ...
        <div style={{ background: '#13131f', border: '1px dashed #2a2a40', borderRadius: 16, padding: 40, textAlign: 'center', marginBottom: 24 }}>
          ...
          <Link href="/" style={{ padding: '12px 28px', background: '#7c6dfa', borderRadius: 10, color: 'white', fontWeight: 600, fontSize: 14, textDecoration: 'none' }}>
            Create My Portfolio →
          </Link>
        </div>
      )}
      ...
      {/* Upgrade CTA */}
      {portfolio && !portfolio.is_pro && <UpgradeCard />}
    </div>
  )
}
  ...
  return (
    <div style={{ background: 'linear-gradient(135deg, rgba(124,109,250,0.1), rgba(250,109,154,0.08))', border: '1px solid rgba(124,109,250,0.2)', borderRadius: 16, padding: 28 }}>
      ...
      <div style={{ color: '#606080', fontSize: 14, marginBottom: 20, lineHeight: 1.6 }}>
        Remove watermark · Analytics · 5 themes · Contact form
      </div>
      <UpgradeButton />
    </div>
  )
